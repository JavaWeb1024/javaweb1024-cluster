package com.dinghao.redis.template;
...
import com.dinghao.redis.datasource.RedisDataSource;
...
public class RedisClientTemplate {
	...
	/**
	 * 为给定key设置生存时间。当key过期时，它会被自动删除。 单位秒(s)
	 * 
	 * @param key
	 * @param unixTime
	 * @return
	 ...
	 * 
	 * @Title: ttl
	 * @Description: TODO(返回给定key的剩余生存时间(time to live)(以秒为单位)。)
	 * @param @param key
	 * @param @return 设定文件
	 * @return Long 返回类型
	 * @throws
	 ...
	 * 
	 * @Title: setbit
	 * @Description: TODO(对key所储存的字符串值，设置或清除指定偏移量上的位(bit)。
	 ...
	 * 
	 * @Title: setex
	 * @Description: TODO(将值value关联到key，并将key的生存时间设为seconds(以秒为单位))
	 * @param @param key
	 * @param @param seconds
	 * @param @param value
	 * @param @return 设定文件
